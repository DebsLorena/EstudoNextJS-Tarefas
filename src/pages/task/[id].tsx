        ...
        <div className={styles.container}>
            ...
            <section className={styles.commentsContainer}>
                ...
                <form onSubmit={handleComment}>
                    ...
                    />
                    <button disabled={!session?.user} className={styles.button}>Enviar comentários</button>
                </form>
            </section>
            ...
            <section className={styles.commentsContainer}>
                ...
                {comments.length === 0 && (
                    <span>Nenhum comnetário foi encontrado...</span>
                )}
                {comments.map((item) => (
